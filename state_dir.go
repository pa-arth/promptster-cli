...
// globalPromptsterDir returns ~/.promptster (global, persists across sessions).
// Used for: bin/, shell-hook.sh, active-workspace pointer.
func globalPromptsterDir() string {
	home, _ := os.UserHomeDir()
	return filepath.Join(home, ".promptster")
}
