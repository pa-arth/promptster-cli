...
func TestRedactGoldenSecrets(t *testing.T) {
	cases := []struct {
		...
		{"github pat", "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"},
...
func TestRedactMultipleSecretsOnePayload(t *testing.T) {
	in := []byte(`{"output":"ANTHROPIC=sk-ant-api03-jSq6OMjv1syXaEUE0bvOckLe_GtCKy8lvZdko3eOJgV8TH-f2iyzRekyZNSby5d9ScikGYuqQhsrxML3X3N3rQ-XwQaQAAA GITHUB=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 KEY=PST-A7K2-M9Q4 done"}`)
	out := redactBytes(in)
