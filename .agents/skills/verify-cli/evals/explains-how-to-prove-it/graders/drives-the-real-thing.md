...
- It names concrete, runnable commands against the real promptster CLI binary, with their flags — not pseudo-steps.
...
- The method it gives is driving the real promptster CLI binary. It does not offer reading source code, or running the unit-test suite, as the way to answer.
