...
func TestCursorAfterShellRedactsSecret(t *testing.T) {
	line := `{"hook_event_name":"afterShellExecution","cursor_version":"2026.02.27","conversation_id":"c1","command":"printenv","output":"TOKEN=ghp_A1b2C3d4E5f6G7h8I9j0K1l2M3n4O5p6Q7r8\n"}`
...
func TestCodexRolloutRedactsSecret(t *testing.T) {
	line := `{"timestamp":"2026-06-06T20:00:00Z","type":"event_msg","payload":{"type":"user_message","message":"deploy with token=ghp_A1b2C3d4E5f6G7h8I9j0K1l2M3n4O5p6Q7r8"}}`
	redacted := redactBytes([]byte(line))
